        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <!-- Capturar id -->
                        <td>
                            <a href="<?php echo base_url('index.php/ReporteTecnologiaPeriodoGeneral/' . $periodo['PER_ID']) ?>" class="btn btn-success">Datos →</a>
                        </td>
                    </tr>
            <?php
                }
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <!-- Capturar id -->
                        <td>
                            <a href="<?php echo base_url('index.php/ReporteTecnologiaPeriodoGeneral/' . $periodo['PER_ID']) ?>" class="btn btn-primary">Datos →</a>
                        </td>
                    </tr>
            <?php
                }
