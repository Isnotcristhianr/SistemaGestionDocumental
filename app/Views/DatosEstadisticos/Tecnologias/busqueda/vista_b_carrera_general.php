        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('index.php/ReporteTecnologiaCarreraGeneral/' . $carreras['CAR_ID']) ?>" class="btn btn-success">Datos  <i class="fa-regular fa-circle-right"></i></a>
                        </td>
                    </tr>
            <?php
                }
        ...
        <tbody>
            ...
            ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('index.php/FiltroEstadisticoGradoBusqueda/Grado/Carrera/Matriculados/' . $carreras['CAR_ID']) ?>" class="btn btn-primary">Datos  <i class="fa-regular fa-circle-right"></i></a>
                            </td>
                        </tr>
            <?php
                    }
        ...
        <tbody>
            ...
            ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('index.php/FiltroEstadisticoGradoBusqueda/Grado/Carrera/Matriculados/' . $carreras['CAR_ID']) ?>" class="btn btn-info">Datos  <i class="fa-regular fa-circle-right"></i></a>
                            </td>
                        </tr>
            <?php
                    }
