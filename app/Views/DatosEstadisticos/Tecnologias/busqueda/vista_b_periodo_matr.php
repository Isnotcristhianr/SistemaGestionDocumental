        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <!-- Capturar id -->
                        <td>
                            <a href="<?php echo base_url('index.php/ReporteTecnologiaPeriodoMatriculados/' . $periodo['PER_ID']) ?>" class="btn btn-success">Datos <i class="fa-regular fa-circle-right"></i></a>
                        </td>
                    </tr>
            <?php
                }
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <!-- Capturar id -->
                        <td>
                            <a href="<?php echo base_url('index.php/ReporteTecnologiaPeriodoMatriculados/' . $periodo['PER_ID']) ?>" class="btn btn-primary">Datos <i class="fa-regular fa-circle-right"></i></a>
                        </td>
                    </tr>
            <?php
                }
    ...
    checkboxes.forEach((checkbox) => {
        checkbox.addEventListener('change', function() {
            ...
            const ruta = valoresSeleccionados.length > 0 ?
                '<?php echo base_url('index.php/SelectorReportePeriodoTecnologiaMatriculados/'); ?>' + valoresSeleccionados.join(',') :
                'javascript:void(0)';
            btnBox.href = ruta;
