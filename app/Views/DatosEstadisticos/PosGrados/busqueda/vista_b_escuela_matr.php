        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php
                                        echo base_url('index.php/ReportePosgradoEscuelaMatriculadosVigente/' . $escuelas['CAR_ID'])
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php
                                        echo base_url('index.php/ReportePosgradoEscuelaMatriculadosHistorico/' . $escuelas['CAR_ID'])
    ...
    checkboxes.forEach((checkbox) => {
        checkbox.addEventListener('change', function() {
            ...
            const ruta = valoresSeleccionados.length > 0 ?
                '<?php echo base_url('index.php/SelectorReporteEscuelaPosgradoMatriculados/'); ?>' + valoresSeleccionados.join(',') :
                'javascript:void(0)';
            btnBox.href = ruta;
