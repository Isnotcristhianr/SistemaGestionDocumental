        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('index.php/ReportePosgradoCarreraGeneral/' . $carreras['CAR_ID']) ?>" class="btn btn-success">Datos →</a>
                        </td>
                    </tr>
            <?php
                }
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('index.php/ReportePosgradoCarreraGeneral/' . $carreras['CAR_ID']) ?>" class="btn btn-primary">Datos →</a>
                        </td>
                    </tr>
            <?php
                }
