<div class="container-center m-5 p-3 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    <!-- Volver -->
    <a href="<?php echo base_url('index.php/verMenuGeneral') ?>" class="btn btn-outline-primary">
    ...
    <div class="row ">
        <div class="col-12">
            ...
            <h4 class="text-center text-dark">Búsqueda: Graduados </h4>
        </div>
        <div class="col-12">
    ...
    <script>
        ...
        //! Por Años General
        {
            ...
            for (let i = 0; i < datos.length; i++) {
                for (let j = 0; j < peri.length; j++) {
                    if (datos[i].ESTM_PERIODO == peri[j].PER_ID && datos[i].ESTM_CONDICION == 3) {
