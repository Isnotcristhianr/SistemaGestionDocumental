...
<div class="container-center m-5 p-3 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    <!-- Volver -->
    <a href="<?php echo base_url('index.php/FiltroEstadisticoTecnologiaBusqueda/Técnicas%20y%20Tecnológicas/Fecha') ?>" class="btn btn-outline-primary">
...
<div class="container-center m-5 p-3 bg-light rounded shadow-lg p-3 mb-5 bg-body rounded ">
    <form action="/SistemaGestionDocumental/index.php/ReporteFechaMatriculadosTecnologiaBusqueda" method="GET" class="form d-flex" style="justify-content: center;">
