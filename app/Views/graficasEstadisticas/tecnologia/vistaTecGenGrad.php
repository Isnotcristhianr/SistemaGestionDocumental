<div class="container-center m-5 p-3 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    ...
    <a href="<?php echo base_url('index.php/FiltroEstadisticoTecnologiaBusqueda/Tecnolog%C3%ADas/Graduados') ?>" class="btn btn-outline-primary">
    ...
    <div class="row ">
        <div class="col-12">
            ...
            <h4 class="text-center text-dark">Búsqueda General Graduados
        </div>
        <div class="col-12">
