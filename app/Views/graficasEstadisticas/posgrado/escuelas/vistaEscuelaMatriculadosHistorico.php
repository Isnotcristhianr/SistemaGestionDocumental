<div class="container-center m-5 p-3 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    <!-- Volver -->
    <a href="<?php echo base_url('index.php/FiltroEstadisticoPosgradoEscuela/Matriculados') ?>" class="btn btn-outline-primary">← Volver</a>
    <div class="row ">
        <div class="col-12">
    ...
    <script>
        ...
        for (var i = 0; i < carrera.length; i++) {
            ...
            if (
                ...
                carrera[i].CAR_ACTIVA == 'No' // Debe estar activa (CAR_ACTIVA = 'SÍ') / o no
            ) {
        ...
        for (let i = 0; i < datos.length; i++) {
            var dato = datos[i];
            if (carreras.includes(dato.ESTM_CARRERA) && (dato.ESTM_SEDE === '1' && dato.ESTM_TIPO === '1' && (dato.ESTM_CONDICION === '1'))) {
