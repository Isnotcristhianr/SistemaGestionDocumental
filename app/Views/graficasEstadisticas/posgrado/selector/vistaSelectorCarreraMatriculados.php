...
<div class="container-center m-5 p-3 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    <!-- Volver -->
    <a href="<?php echo base_url('index.php/FiltroEstadisticoPosgradoCarrera/Matriculados') ?>" class="btn btn-outline-primary">
    ...
    <script>
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            var filteredData = datos.filter(function(dato) {
                return dato.ESTM_CARRERA == ids[i] && dato.ESTM_TIPO === '1' && (dato.ESTM_CONDICION === '1');
            });
