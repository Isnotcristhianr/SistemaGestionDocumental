<div class="container-center m-5 p-3 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    <!-- Volver -->
    <a href="http://localhost/SistemaGestionDocumental/index.php/FiltroEstadisticoGradoEscuela/Matriculados" class="btn btn-outline-primary">← Volver</a>
    <div class="row ">
        <div class="col-12">
...
<div class="container-center m-5 p-1 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    ...
    <script>
        ...
        for (let i = 0; i < datos.length; i++) {
            var dato = datos[i];
            if (carreras.includes(dato.ESTM_CARRERA) && (dato.ESTM_SEDE === '2' && dato.ESTM_TIPO === '2' && dato.ESTM_CONDICION === '1')) {
