...
<div class="container-center m-5 p-3 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    <!-- Volver -->
    <a href="<?php echo base_url('index.php/FiltroEstadisticoGradoBusqueda/Grado/Fecha?consulta=') ?>" class="btn btn-outline-primary">
    <i class="fa-solid fa-caret-left"></i> Volver</a>
    <div class="row ">
        <div class="col-12">
...
<div class="container-center m-5 p-3 bg-light rounded shadow-lg p-3 mb-5 bg-body rounded ">
    <form action="/SistemaGestionDocumental/index.php/ReporteFechaGeneralBusqueda" method="GET" class="form d-flex" style="justify-content: center;">
