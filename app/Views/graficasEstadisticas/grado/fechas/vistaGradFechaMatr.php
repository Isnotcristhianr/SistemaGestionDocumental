...
<div class="container-center m-5 p-3 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    <!-- Volver -->
    <a href="    http://localhost/SistemaGestionDocumental/index.php/FiltroEstadisticoGradoBusqueda/Grado/Fecha?consulta=" class="btn btn-outline-primary">← Volver</a>
    <div class="row ">
        <div class="col-12">
...
<div class="container-center m-5 p-3 bg-light rounded shadow-lg p-3 mb-5 bg-body rounded ">
    <form action="/SistemaGestionDocumental/index.php/ReporteFechaMatriculadosBusqueda" method="GET" class="form d-flex" style="justify-content: center;">
