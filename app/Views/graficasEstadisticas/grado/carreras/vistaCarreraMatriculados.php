<div class="container-center m-5 p-3 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    <!-- Volver -->
    <a href="<?php echo base_url('index.php/FiltroEstadisticoGradoCarrera/Matriculados') ?>" class="btn btn-outline-primary">
...
<div class="container-center m-5 p-1 bg-light rounded col-xs-6 shadow-lg p-3 mb-5 bg-body rounded">
    ...
    <script>
        ...
        var filteredData = datos.filter(function(dato) {
            return dato.ESTM_CARRERA == carid && (dato.ESTM_TIPO === '2' && dato.ESTM_CONDICION === '1');
        });
