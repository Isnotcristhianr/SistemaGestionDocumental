...
class ControladorFEPeriodo extends BaseController
{
    ...
    public function reporteGradoPeriodoGeneral($perid)
    {
        try {
            ...
            return view('header')
                . view('/graficasEstadisticas/grado/periodos/vistaPeriodoGeneral', $datos + $datos2 + $datos3)
                . view('footer');
        } catch (\Exception $e) {
            echo $e->getMessage();
        }
    ...
    public function reportePosgradoPeriodoGeneral($perid)
    {
        try {
            ...
            return view('header')
                . view('/graficasEstadisticas/posgrado/periodos/vistaPeriodoGeneral', $datos + $datos2 + $datos3)
                . view('footer');
        } catch (\Exception $e) {
            echo $e->getMessage();
        }
